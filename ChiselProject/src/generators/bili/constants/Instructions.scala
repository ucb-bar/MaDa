...
object Instructions {
  ...
  def VADD_VV            = BitPat("b000000???????????001?????1010111")
  def VADD_VF            = BitPat("b000000???????????101?????1010111")
  def VXOR_VV            = BitPat("b001011???????????000?????1010111")
  def VFMIN_VV           = BitPat("b000101???????????000?????1010111")
  def VFMAX_VV           = BitPat("b000111???????????000?????1010111")
  def VFMUL_VV           = BitPat("b100101???????????001?????1010111")
  def VFMACC_VV          = BitPat("b101100???????????001?????1010111")
  def VLE32_V            = BitPat("b000000100000?????110?????0000111")
  def VLSE32_V           = BitPat("b000010100000?????110?????0000111")

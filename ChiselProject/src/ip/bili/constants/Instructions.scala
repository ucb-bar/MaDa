...
object Instructions {
  ...
  def VADD_VV            = BitPat("b0000000??????????001?????1010111")
  def VADD_VF            = BitPat("b0000000??????????101?????1010111")
  def VFMIN_VV           = BitPat("b0001000??????????001?????1010111")
  def VFMAX_VV           = BitPat("b0001100??????????001?????1010111")
  def VFMUL_VV           = BitPat("b1001000??????????001?????1010111")
  def VFMACC_VV          = BitPat("b1011000??????????001?????1010111")
  def VLE32_V            = BitPat("b000000100000?????110?????0000111")
  def VSE32_V            = BitPat("b000000100000?????110?????0100111")
}
object Causes {
